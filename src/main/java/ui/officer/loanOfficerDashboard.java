...
public class loanOfficerDashboard extends JFrame {
        ...
        public loanOfficerDashboard(int user_id, int officerId, JFrame QueueView) {
                ...
                try {
                        LoanOfficer officerID = LoanOfficerApiClient.getLoanOfficerByUserId(user_id);
                ...
                assignedLabel = createStatCard(
                                "Assigned Applications",
                                "0");

                pendingLabel = createStatCard(
                                "Pending",
                                "0");

                approvedLabel = createStatCard(
                                "Approved",
                                "0");

                deniedLabel = createStatCard(
                                "Denied",
                                "0");
                ...
                queueButton = new JButton("Open Queue");
        ...
        private void loadStats() {
                try {
                        ...
                        List<LoanApplication> applications = LoanApplicationApi.getApplicationsByOfficer(
                                        officerId);
